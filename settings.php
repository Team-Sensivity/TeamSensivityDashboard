...
//USER BESITZT DBD
if (!empty($connections["steam"]["connect_id"])) {
    $url = 'https://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=' . $SteamAPIKey . '&steamid=' . $connections["steam"]["connect_id"];
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div id="settingsEmailHelp" class="form-text">Muss per E-Mail bestätigt
                                                werden...
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="tab-pane fade <?php if ((isset($_GET["steam_id"]) || isset($_GET["riot_id"]) || $active == "connect") && $active != "dbd") {
                            echo "show active";
                        } ?>" id="verknupfen" role="tabpanel" aria-labelledby="security-tab">
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <?php if (isset($connections["steam"]["connect_id"])) {
                                               ...
                                               ';
                                                ...
                                                echo '
                                                                 ...
                                                                 <label for="settingsCurrentPassword"
                                                               class="form-label">SteamAccount</label>
                                                        <a class="btn btn-primary" href="/connect/init-openId.php">Jetzt SteamAccount verknüpfen</a>
                                            ...
                                            <form method="get">
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                           ...
                                                           required <?php if (isset($user["riot_puuid"])) {
                                                        echo 'disabled value="' . $user["summoner_name"] . '"';
                                                    } ?>>
                                                    <button type="submit"
                                                            class="btn btn-primary btn-style-light"
                                                            id="settingsNewPassword" <?php if (isset($user["steam_id"])) {
                                                        echo 'disabled';
                                                    } ?>>Add
                                                    </button>
                                                </div>
                        ...
                        <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row m-t-xxl">
                                        <div class="col-md-6">
                                            <label for="settingsConfirmPassword" class="form-label">Neues
                                                Passwort</label>
                                            <input type="password" class="form-control"
                                                   aria-describedby="settingsConfirmPassword"
                                                   placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                                    ...
                                    <div class="row m-t-xxl">
                                        <div class="col-md-6">
                                            <label for="settingsConfirmPassword" class="form-label">Passwort
                                                wiederholen</label>
                                            <input type="password" class="form-control"
                                                   aria-describedby="settingsConfirmPassword"
                                                   placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                        ...
                        <div class="tab-pane fade <?php if ($active == "dbd") {
                            echo "show active";
                        } ?>" id="dbd" role="tabpanel" aria-labelledby="integrations-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row m-t-xxl">
                                        <div class="col-md-12">
