    ...
    <div class="app-content">
        ...
        <div class="content-menu content-menu-right">
            <ul class="list-unstyled">
                ...
                <li><a href="./satisfactory-server.php" class="active">Satisfactory</a></li>
                <li><a href="./minecraft-server.php">Minecraft</a></li>
                <li><a href="#">Space</a></li>
                <li class="divider"></li>
                <li><a href="./satisfactory-server.php">Übersicht</a></li>
                    ...
                    <div class="col">
                        <div class="page-description d-flex align-items-center">
                            ...
                            <div class="page-description-actions">
                                ...
                                <?php
                                    $status = getServerStatus("satisfactory");
                                ?>
                                <button id="start" <?php if($status[0] == 0){echo "disabled";}?> onclick="startServer('http://192.168.178.202:8080/start-server');" class="btn btn-success">Start Server</button>
                                <button id="restart" <?php if($status[1] == 0){echo "disabled";}?>  onclick="restartServer('http://192.168.178.202:8080/restart-server');" class="btn btn-warning">Restart Server</button>
                                <button id="stop" <?php if($status[2] == 0){echo "disabled";}?>  onclick="stopServer('http://192.168.178.202:8080/stop-server');" class="btn btn-danger">Stop Server</button>
                            </div>
                        </div>
                    </div>
                </div>
